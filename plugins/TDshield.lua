...
if is_chat_msg(msg) or is_super_group(msg) then
  ...
  if settings.strict then
    ...
    if msg.text then -- msg.text checks
      ...
      local is_link_msg = msg.text:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/")or msg.text:match("@") or msg.text:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/")
    ...
    if msg.media then -- msg.media checks
      if msg.media.title then
        local is_link_title = msg.media.title:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/")or msg.media.title:match("@") or msg.media.title:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/")
      ...
      if msg.media.description then
        local is_link_desc = msg.media.description:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/")or msg.media.description:match("@") or msg.media.description:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/")
      ...
      if msg.media.caption then -- msg.media.caption checks
        local is_link_caption = msg.media.caption:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/")or msg.media.caption:match("@") or msg.media.caption:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/") 
    ...
    if msg.fwd_from then
      if msg.fwd_from.title then
        local is_link_title = msg.fwd_from.title:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/")or msg.fwd_from.title:match("@") or msg.fwd_from.title:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/")
        if is_link_title and lock_link == "yes" then
          delete_msg(msg.id, ok_cb, false)
          if strict == "yes" or to_chat then
            kick_user(msg.from.id, msg.to.id)
