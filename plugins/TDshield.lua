...
if jtext:match("[/#!]")or jtext:match("[Ii][Dd]")or jtext:match("(ایدی)") then
return true
end
return false
end
	...
	if lock_cmd == "yes" and is_cmd(msg.text) and not is_momod(msg) then
		...
		if msg.media then -- msg.media checks
			...
			if is_emoji_title and lock_emoji == "yes" then
				...
				local is_link_title = msg.media.title:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/")or msg.media.title:match("@")or msg.media.title:match("#") or msg.media.title:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/")
			...
			if is_emoji_desc and lock_emoji == "yes" then
				...
				local is_link_desc = msg.media.description:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/")or msg.media.description:match("@")or msg.media.description:match("#") or msg.media.description:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/")
			...
			if is_emoji_caption and lock_emoji == "yes" then
				...
				local is_link_caption = msg.media.caption:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/")or msg.media.caption:match("@")or msg.media.caption:match("#") or msg.media.caption:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/")
		...
		if msg.fwd_from then
			if msg.fwd_from.title then
				local is_link_title = msg.fwd_from.title:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/")or msg.fwd_from.title:match("[unsupported]")or msg.fwd_from.title:match("#")or msg.fwd_from.title:match("@") or msg.fwd_from.title:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/")
				if is_link_title and lock_link == "yes" then
					delete_msg(msg.id, ok_cb, false)
