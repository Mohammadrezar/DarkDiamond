	...
	if settings.strict then
		...
		if msg.media then -- msg.media checks
			if msg.media.title then
				local is_link_title = msg.media.title:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/")or msg.media.title:match("#") or msg.media.title:match("@")
or msg.media.title:match("(.+)") or msg.media.title:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/")
			...
			if msg.media.description then
				local is_link_desc = msg.media.description:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/")or msg.media.description:match("(.+)") or msg.media.description:match("@") or msg.media.description:match("#")
 or msg.media.description:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/")
			...
			if msg.media.caption then -- msg.media.caption checks
				local is_link_caption = msg.media.caption:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]/") or msg.media.caption:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]/") or msg.media.caption:match("@")
 or msg.media.caption:match("#") or msg.media.caption:match("(.+)")
