...
local XMLElement = (loadfile "./TeleDiamond/libs/XMLElement.lua")()
local dateparser = (loadfile "./TeleDiamond/libs/dateparser.lua")()
local URL = (loadfile "./TeleDiamond/libs/url.lua")()
