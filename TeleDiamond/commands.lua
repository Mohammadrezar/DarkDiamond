...
serpent = (loadfile "./TeleDiamond/libs/serpent.lua")()
feedparser = (loadfile "./TeleDiamond/libs/feedparser.lua")()
json = (loadfile "./TeleDiamond/libs/JSON.lua")()
mimetype = (loadfile "./TeleDiamond/libs/mimetype.lua")()
redis = (loadfile "./TeleDiamond/libs/redis.lua")()
JSON = (loadfile "./TeleDiamond/libs/dkjson.lua")()
...
function download_to_file(url, file_name)
  print("(@mrr619) file has been saved in: "..url)
...
local file = io.open("./TeleDiamond/chats/logs/"..group.."log.txt", "a")
